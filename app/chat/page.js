...
export default function ChatPage() {
  ...
  return (
    <div className="animate-fade-in" style={{ height: 'calc(100vh - 4rem)', display: 'flex', gap: 20 }}>
      {/* Left: Rooms + Doctors */}
      <div style={{ width: 300, flexShrink: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div>
          <h1 style={{ fontFamily: 'Poppins', fontWeight: 800, fontSize: '1.3rem', color: '#1a1a2e', marginBottom: 4 }}>{t('chat')}</h1>
          <p style={{ color: '#4a5568', fontSize: '0.8rem' }}>Consult your doctors securely</p>
        </div>
        ...
        {profile?.role === 'patient' && (
          <div className="card" style={{ padding: '1rem' }}>
            <div style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: '0.875rem', color: '#1a1a2e', marginBottom: 10, display: 'flex', alignItems: 'center', gap: 6 }}>
              <Plus size={14} color="#f08000" /> Start New Consultation
            </div>
            <div style={{ position: 'relative', marginBottom: 10 }}>
              <Search size={13} style={{ position: 'absolute', left: 9, top: '50%', transform: 'translateY(-50%)', color: '#9ca3af' }} />
              <input type="text" value={searchDr} onChange={e => setSearchDr(e.target.value)} placeholder="Search doctors..." style={{ width: '100%', padding: '7px 8px 7px 28px', borderRadius: 8, border: '1px solid #f0e8d8', fontSize: '0.8rem', outline: 'none' }} />
            </div>
        ...
        <div className="card" style={{ padding: '1rem', flex: 1, overflow: 'auto' }}>
          <div style={{ fontFamily: 'Poppins', fontWeight: 700, fontSize: '0.875rem', color: '#1a1a2e', marginBottom: 10 }}>Conversations</div>
          {rooms.length === 0 ? (
        ...
        {activeRoom ? (
          <>
            ...
            <div style={{ background: 'white', borderRadius: 16, padding: '1rem 1.5rem', marginBottom: 12, border: '1px solid #f0e8d8', display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
                <span style={{ fontSize: '0.75rem', color: '#4a5568', background: '#f5f5f5', padding: '4px 10px', borderRadius: 20 }}>🔒 End-to-End Secure</span>
              </div>
            </div>
          ...
          <div className="card" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ textAlign: 'center', color: '#9ca3af' }}>
              ...
              <p style={{ fontFamily: 'Poppins', fontWeight: 600, color: '#4a5568' }}>Select a conversation</p>
