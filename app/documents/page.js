  ...
  return (
    <div className="animate-fade-in">
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontFamily: 'Poppins', fontWeight: 800, fontSize: '1.5rem', color: '#1a1a2e' }}>{t('medical_records')}</h1>
        <p style={{ color: '#4a5568', fontSize: '0.875rem', marginTop: 4 }}>Upload and manage your health documents securely</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 24, marginBottom: 28 }}>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div>
              <label style={{ display: 'block', fontWeight: 600, fontSize: '0.8rem', color: '#1a1a2e', marginBottom: 5 }}>Document Name</label>
            ...
            <div>
              <label style={{ display: 'block', fontWeight: 600, fontSize: '0.8rem', color: '#1a1a2e', marginBottom: 5 }}>Document Type</label>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            { label: 'Total Documents', value: docs.length, color: '#f08000' },
            { label: 'Lab Reports', value: docs.filter(d => d.doc_type === 'Lab Report').length, color: '#10b981' },
            { label: 'Prescriptions', value: docs.filter(d => d.doc_type === 'Prescription').length, color: '#4f46e5' },
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 16, flexWrap: 'wrap', alignItems: 'center' }}>
        <div style={{ position: 'relative', flex: 1, minWidth: 200 }}>
          ...
          <input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Search documents..." style={{ width: '100%', padding: '9px 12px 9px 36px', borderRadius: 10, border: '1px solid #f0e8d8', fontSize: '0.875rem', outline: 'none' }} />
        </div>
      ...
      {filtered.length === 0 ? (
        <div className="card" style={{ textAlign: 'center', padding: '3rem' }}>
          ...
          <p style={{ color: '#4a5568' }}>No documents found</p>
